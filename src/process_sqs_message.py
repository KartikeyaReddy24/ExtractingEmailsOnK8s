...
def process_sqs_message():
    while True:
        ...
        client = boto3.resource('sqs',aws_access_key_id=os.environ.get('AWS_ACCESS_KEY_ID'),
                                aws_secret_access_key=os.environ.get('AWS_SECRET_ACCESS_KEY'),region_name=REGION_NAME_SQS)
